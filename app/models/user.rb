class User < ApplicationRecord
  ...
  enum exercise: {do_noting: 0, once_or_twice_a_week: 1, two_or_three_times_a_week: 2,
                  three_or_five_times_a_week: 3, everyday: 4}
  ...
  # when "do_noting"
  #   1.2
  # when "once_or_twice_a_week"
  #   1.375
  # when "two_or_three_times_a_week"
  #   1.55
  # when "three_or_five_times_a_week"
  #   1.725
  # when "everyday"
  #   1.9
  # end
